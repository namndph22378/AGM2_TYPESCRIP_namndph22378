const Header = () => {
    return <header className="bg-red-500">
        <div className="container w-3/4  h-[64px] mx-auto flex items-center gap-7">
            <a href="/">      <img className="w-[64px] pl-1" src="" alt="" /></a>
            ...
            <div className="pl-40 ">
                ...
                <a href="/signup"
                    className="inline-block text-sm px-4 py-2 ml-4 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0"><button>Signup</button></a>
            </div>
        </div>
