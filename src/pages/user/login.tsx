      ...
      <div className=" flex  bg-white rounded-lg shadow dark:border md:mt-0 xl:p-0 dark:bg-[#F8F8F8] dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            message: "Địa chỉ email không đúng định dạng cần"
                  ...
                  <div>
                    <p className="text-center">Bạn đã có tài khoản chưa? 
              <a href="/signup" className=" mt-10 w-full rounded-lg text-sm px-5 py-2.5 text-center text-blue-600"><button>Sign Up</button></a>
              ...
              {/* <a href="/signup" className=" mt-10 w-full rounded-lg text-sm px-5 py-2.5 text-center "><button>Sign In</button></a> */}
          </div>
